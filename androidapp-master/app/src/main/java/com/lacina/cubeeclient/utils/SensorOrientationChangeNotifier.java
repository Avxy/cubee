...
public class SensorOrientationChangeNotifier {
    ...
    public static SensorOrientationChangeNotifier getInstance(Context ctx) {
        if (mInstance == null)
            mInstance = new SensorOrientationChangeNotifier(ctx);

        return mInstance;
    }

    private SensorOrientationChangeNotifier(Context ctx) {
