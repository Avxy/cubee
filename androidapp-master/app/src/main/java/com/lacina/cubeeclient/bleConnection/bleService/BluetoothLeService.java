...
package com.lacina.cubeeclient.bleConnection.bleService;
...
public class BluetoothLeService extends Service {
    ...
    public final static String ACTION_DATA_WRITE = BluetoothLeService.class.getName() + ".ACTION_DATA_WRITE";
    ...
    private final BluetoothGattCallback mGattCallback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status) {
            ...
            if (status == BluetoothGatt.GATT_SUCCESS) {
                ...
                Log.w(TAG, "onCharWrite received: " + status);
            }
        }
    };
    ...
    private boolean refreshDeviceCache() {
        try {
            ...
            if (localMethod != null) {
                return (boolean) (Boolean) localMethod.invoke(localBluetoothGatt);
            }
